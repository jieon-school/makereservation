      ...
      <div className="container" style={{
        ...
        >
          ...
          <div>
            ...
            <p className="navbar-logo-subtitle" style={{ fontSize: '0.7rem', color: '#64748B', lineHeight: 1.2 }}>
              1:1 맞춤형 개인 상담
            </p>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', flexWrap: 'nowrap' }}>
          ...
          {onManualSync && (
            ...
            >
              ...
              <span className="cloud-sync-text">{isSyncing ? '동기화 중' : isCloudConnected ? '연동됨' : '새로고침'}</span>
            </button>
          )}

          {/* Tab Navigation Buttons */}
          <nav style={{ display: 'flex', gap: '0.25rem', background: '#F1F5F9', padding: '3px', borderRadius: '12px' }}>
            <button
              ...
              style={{
                ...
                boxShadow: activeTab === 'booking' ? '0 2px 5px rgba(0,0,0,0.06)' : 'none'
              }}
            >
              <Calendar size={14} />
              <span>예약</span>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: activeTab === 'lookup' ? '0 2px 5px rgba(0,0,0,0.06)' : 'none'
              }}
            >
              <Search size={14} />
              <span>조회</span>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: activeTab === 'admin' ? '0 2px 5px rgba(0,0,0,0.06)' : 'none'
              }}
            >
              <ShieldCheck size={14} />
              <span>교사</span>
